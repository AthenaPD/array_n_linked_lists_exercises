...
describe("reverse", function() {
  it("reverse a linked list", function() {
    let lst = new LinkedList([2, 3, 1, 1, 7, 6, 9]);
    expect(lst.reverse()).toEqual(new LinkedList([9, 6, 7, 1, 1, 3, 2]));
  });

  it("reverse a linked list with length 1", function() {
    let lst = new LinkedList([10]);
    expect(lst.reverse()).toEqual(new LinkedList([10]));
  });

  it("reverse a linked list with length 0", function() {
    let lst = new LinkedList([]);
    expect(lst.reverse()).toEqual(new LinkedList([]));
  });
});
...
describe("pivot", function() {
  it("pivot around a value", function() {
    ...
    expect(lst.pivot(5)).toEqual(new LinkedList([2,3,1,1,7,6,9]));
  });

  it("pivot around a value with value in list", function() {
    let lst = new LinkedList([7, 6, 2, 5, 3, 5, 9, 1, 1]);
    expect(lst.pivot(5)).toEqual(new LinkedList([2,3,1,1,7,6,5,5,9]));
  });
});
