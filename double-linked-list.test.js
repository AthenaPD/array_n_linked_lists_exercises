...
describe("setAt", function() {
  ...
  it("sets val at index -- longer list", function() {
    let lst = new DoublyLinkedList([5, 10, 12, 15, 20, 28, 30]);

    lst.setAt(4, 21);
    lst.setAt(6, 32);
    expect(lst.head.next.next.next.next.val).toBe(21);
    expect(lst.tail.val).toBe(32);
  });
});
